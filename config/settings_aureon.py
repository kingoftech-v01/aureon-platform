...
# Security
SECRET_KEY = env('SECRET_KEY', default='django-insecure-CHANGE-IN-PRODUCTION-aureon-2025')
DEBUG = env('DEBUG')
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',
    BASE_DIR / 'W3 CRM',  # Dashboard template
    BASE_DIR / 'gratech-buyer' / 'assets',  # Marketing site assets
]
...
SERVER_EMAIL = 'alerts@rhematek-solutions.com'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Aureon API - Rhematek Solutions',
    'DESCRIPTION': 'Automated Financial Management Platform - From Signature to Cash',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'SCHEMA_PATH_PREFIX': '/api',
    'CONTACT': {
        'name': 'Stéphane Arthur Victor',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'aureon.log',
...
# ====================
# AUREON CUSTOM SETTINGS
# ====================

# Company Information
COMPANY_NAME = 'Rhematek Solutions'
PROJECT_NAME = 'Aureon'
CEO_NAME = 'Stéphane Arthur Victor'
CEO_EMAIL = 'stephane@rhematek-solutions.com'
ADMIN_EMAIL = 'alerts@rhematek-solutions.com'
SITE_URL = env('SITE_URL', default='https://aureon.rhematek-solutions.com')

...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Name of the company (if client is a company)",
                        max_length=255,
                ...
                (
                    "first_name",
                    models.CharField(
                        help_text="First name of primary contact",
                        max_length=100,
                ...
                (
                    "last_name",
                    models.CharField(
                        help_text="Last name of primary contact",
                        max_length=100,
                ...
                (
                    "country",
                    models.CharField(
                        default="United States", max_length=100, verbose_name="Country"
                    ),
                ),
                (
                    "industry",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text='Number of employees (e.g., "1-10", "11-50", etc.)',
                        max_length=50,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Tax identification number or VAT number",
                        max_length=50,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("prospect", "Prospect - Qualified Lead"),
                            ("active", "Active Client"),
                            ("inactive", "Inactive"),
                            ("churned", "Churned"),
                        ],
                        default="lead",
                        help_text="Current stage in the customer lifecycle",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text='How the client found you (e.g., "Website", "Referral", "Cold Outreach")',
                        max_length=100,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Total value of all contracts",
                        max_digits=12,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether client can access the client portal",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Team member responsible for this client",
                        null=True,
                ...
                (
                    ...
                    models.OneToOneField(
                        blank=True,
                        help_text="User account for client portal access",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Note subject or title",
                        max_length=255,
        ...
        migrations.AddIndex(
            model_name="client",
            index=models.Index(
                fields=["lifecycle_stage"], name="clients_cli_lifecyc_dc3d2b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="client",
            index=models.Index(fields=["owner"], name="clients_cli_owner_i_89d16e_idx"),
        ),
        migrations.AddIndex(
            model_name="client",
            index=models.Index(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(
                        ("client_type", "company"), ("company_name__isnull", False)
                    ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["client", "-created_at"], name="clients_cli_client__ff8b35_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clientnote",
            index=models.Index(
                fields=["client", "-created_at"], name="clients_cli_client__b25648_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clientnote",
            index=models.Index(
                fields=["author"], name="clients_cli_author__0cc072_idx"
            ),
        ),
    ]

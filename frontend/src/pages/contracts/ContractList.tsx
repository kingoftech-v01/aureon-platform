 ...
 *
 * Main contract management page with table, search, and filters
 */
...
import type { Contract, ContractStatus, PaginationConfig, SortConfig } from '@/types';
...
const ContractList: React.FC = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['contracts', pagination, sort, statusFilter, searchQuery],
    queryFn: () =>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {data ? `${data.count} Contract${data.count !== 1 ? 's' : ''}` : 'Contracts'}
          </CardTitle>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            <>
              <Table>
                <TableHead>
                  <TableRow>
                    <TableHeaderCell
                      ...
                      sortDirection={sort.field === 'contract_number' ? sort.direction : null}
                    >
                      Contract #
                    </TableHeaderCell>
                    ...
                    <TableHeaderCell
                      ...
                      sortDirection={sort.field === 'total_value' ? sort.direction : null}
                      align="right"
                    >
                      Value
                    </TableHeaderCell>
                    <TableHeaderCell
                      ...
                      sortDirection={sort.field === 'start_date' ? sort.direction : null}
                    >
                      Start Date
                    </TableHeaderCell>
                ...
                <TableBody>
                  {data.results.map((contract: Contract) => (
                    <TableRow
                      key={contract.id}
                      hoverable

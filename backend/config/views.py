...
Frontend rendering is handled by the React SPA (Vite) for all routes
(both marketing/home and dashboard).
"""
import os
...
class HomeView(View):
    """
    Home view that serves the React SPA.
    The React app handles marketing/home routes via client-side routing.
    """
